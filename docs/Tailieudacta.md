...
5. Log kết quả và lưu link video gốc.
...
- **Kiểm tra trùng lặp:** Trước khi tải, hệ thống kiểm tra link video trên Google Sheet (cột "Link Video Gốc"). Nếu link đã tồn tại, bỏ qua và tìm video khác để tránh lấy lại video cũ.
...
### Bước 7: Ghi Log và Hoàn tất
- Lưu log vào Google Sheet bao gồm: Keyword, Link Video Gốc, Link Affiliate, Trạng thái.
...
| Keyword | Link Video Gốc | Nguồn Nền tảng | Link Shopee Gốc | Link Affiliate | Trạng thái |
| :--- | :--- | :--- | :--- | :--- | :--- |
| Máy pha cà phê | `douyin.com/video/123` | Douyin | `shopee.vn/product/123` | `shp.ee/abcxyz` | Thành công |